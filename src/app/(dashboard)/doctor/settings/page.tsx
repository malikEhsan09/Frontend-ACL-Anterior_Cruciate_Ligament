...
const Settings: React.FC<SettingsProps> = ({ onUpdateProfileImage  }) => {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8800/api/doctor/${userId}`,
        {
          method: "GET",
          headers: myHeaders,
        }
      ...
      if (response.ok) {
        ...
        setProfileInfo({
                          ...
                          medicalLicenseNo: result.medicalLicenseNo || "",
        ...
        console.error("Failed to fetch profile data of Doctor", response.status);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    ...
    formdata.append("medicalLicenseNo", profileInfo.medicalLicenseNo);
    formdata.append("specialization", profileInfo.specialization);
  ...
  return (
    <div className="p-6 bg-white min-h-screen">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-gray-600 font-semibold">Medical License Number</p>
            <p className="text-gray-800">{profileInfo.medicalLicenseNo}</p>
          </div>
          <div>
            <p className="text-gray-600 font-semibold">Specialization</p>
            <p className="text-gray-800">{profileInfo.specialization}</p>
          </div>
        </div>
        <div>
